...
Auth required. Заявка подаётся от команды: подать её может только капитан, команда привязывается к заявке автоматически.
...
- подать заявку может только капитан команды;
- одна команда не может подать заявку на тот же квест повторно;
