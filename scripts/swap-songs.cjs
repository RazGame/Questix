 ...
 *
 * Сейчас настроен на блок «90–2000-е — русский рок»: возвращаем Земфиру —
 * «Хочешь?». Место освобождает «Владивосток 2000»: песня известная, но не из
 * тех, что зал подпевает хором, а у самого Мумий Тролля есть вещи узнаваемее.
 *
...
const REMOVE = [
  { a: 'Mumiy Troll', t: 'Владивосток 2000' },
];

// кого поставить. start — за ~3 с до припева, отрезок 20 с.
const ADD = [
  { a: 'Zemfira', t: 'Хочешь?', start: 54 },
];
