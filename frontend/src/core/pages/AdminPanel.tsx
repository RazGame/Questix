...
import { gameService } from '../../games/quest/services/games';
import { applService } from '../../games/quest/services/appls';
import { progressService } from '../../games/quest/services/progress';
import { taskService } from '../../games/quest/services/tasks';
...
type MainTab = string; // 'games' | 'users' | id вкладки модуля из реестра

const mainTabFromValue = (value: unknown): MainTab | null =>
  value === 'games' || value === 'users' || moduleTabs.some((t) => t.id === value)
    ? (value as MainTab)
    : null;
