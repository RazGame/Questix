 ...
 *
 * Проверено на живом устройстве: на iOS 17.6 отклика нет ни через полифил
 * (он ставит себя только с Safari 18), ни напрямую переключателем. С 18-й
 * версии заработает само, без изменений в коде.
 *
